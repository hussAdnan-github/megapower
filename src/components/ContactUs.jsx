...
const ContactUs = () => {
  ...
  return (
    ...
    <section className="">
  <div className="flex px-4 md:px-0 pt-4 md:pt-0 flex-col lg:flex-row h-64 items-center justify-between bg-gradient-to-r from-blue-700 to-white shadow-xl lg:p-12 text-white text-center lg:text-right">
